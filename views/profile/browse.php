...
<main class="container-xl px-3 px-sm-4 py-4">
    ...
    <section class="text-center py-5 my-2 position-relative">
        <p class="browse-hero__eyebrow text-uppercase fs-fluid-xs">Discover Remarkable Commission Artists</p>
        ...
        <div class="search-bar mx-auto mb-4">
            ...
            <input type="text" class="search-bar__input fs-fluid-sm" id="searchInput" placeholder="Search by name, style, or keyword…">
        ...
        <div class="browse-hero__chips d-flex flex-wrap justify-content-center gap-2">
            <button class="category-chip active fs-fluid-xs" data-style="all"><span class="category-chip__dot"></span> All Styles</button>
            <button class="category-chip fs-fluid-xs" data-style="digital"><span class="category-chip__dot"></span> Digital Art</button>
            <button class="category-chip fs-fluid-xs" data-style="traditional"><span class="category-chip__dot"></span> Traditional</button>
            <button class="category-chip fs-fluid-xs" data-style="chibi"><span class="category-chip__dot"></span> Chibi</button>
            <button class="category-chip fs-fluid-xs" data-style="anime"><span class="category-chip__dot"></span> Anime</button>
            <button class="category-chip fs-fluid-xs" data-style="portrait"><span class="category-chip__dot"></span> Portrait</button>
            <button class="category-chip fs-fluid-xs" data-style="fanart"><span class="category-chip__dot"></span> Fan Art</button>
        </div>
    </section>
            ...
            <div class="col-lg-9">
                ...
                <div class="browse-results-bar d-flex align-items-center justify-content-between flex-wrap gap-3 mb-3">
                    ...
                    <div class="browse-sort d-flex align-items-center gap-2">
                        ...
                        <select id="sortSelect" class="form-select form-select-sm border fs-fluid-xs" aria-label="Sort artists">
                ...
                <div id="artistGridError" class="grid-state d-none text-center py-5 px-3 border rounded-3 bg-card shadow-sm">
                    ...
                    <p class="grid-state__title fw-bold text-primary m-0 mb-1 fs-fluid-sm">Something went wrong</p>
                    <p class="grid-state__sub text-muted mx-auto mb-3 fs-fluid-xs" style="max-width:320px;">We couldn't load the artist list. Please refresh and try again.</p>
                ...
                <div id="artistGridEmpty" class="grid-state d-none text-center py-5 px-3 border rounded-3 bg-card shadow-sm">
                    ...
                    <p class="grid-state__title fw-bold text-primary m-0 mb-1 fs-fluid-sm">No artists found</p>
                    <p class="grid-state__sub text-muted mx-auto m-0 fs-fluid-xs" style="max-width:320px;">Try adjusting your filters or search with different keywords.</p>
                </div>
    ...
    <section class="top-artists py-2">
        <div class="top-artists__header d-flex align-items-end justify-content-between mb-4 flex-wrap gap-2">
            <div>
                <p class="top-artists__label text-uppercase fw-bold m-0 mb-1 fs-fluid-xs">Community Picks</p>
                <h2 class="top-artists__title fw-normal position-relative m-0 fs-fluid-lg">Top Artists</h2>
            </div>
            <a href="#" class="top-artists__view-all d-inline-flex align-items-center gap-1 text-decoration-none fw-semibold fs-fluid-xs">
                View all
