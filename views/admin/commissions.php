...
<main class="py-5">
    <div class="container-fluid px-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="joan mb-0">Commission Manager</h2>
                <p class="text-muted mb-0">Overview of all active and pending requests</p>
            </div>
        ...
        <div class="card theme-border border-0 shadow-sm p-0 overflow-hidden"
                ...
                <table class="table align-middle mb-0">
                    ...
                    <tbody>
                        <tr style="border-bottom: 1px solid var(--clr-border);">
                            ...
                            <td class="p-3">
                                <span class="badge"
                                    style="background-color: var(--clr-open); color: white;">Pending</span>
                            </td>
