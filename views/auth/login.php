                    ...
                    <div class="col-12 col-md-7 form-side p-5 d-flex flex-column align-items-center justify-content-center" style="background-color: #ffffff !important; border-top-right-radius: 30px !important; border-bottom-right-radius: 30px !important;">
                        ...
                        <form class="w-100 px-lg-4">
                            ...
                            <div class="text-center mb-4 d-flex flex-column align-items-center">
                                ...
                                <a href="#" class="forgot-password-link" style="color: #dfba94 !important; text-decoration: underline !important; text-underline-offset: 4px !important; font-size: 0.9rem !important; font-weight: 500 !important;">Forgot Password?</a>
                            </div>
                        </form>

                        <div class="social-medias d-flex gap-4 justify-content-center mt-2" style="display: flex !important; justify-content: center !important; gap: 1.5rem !important;">
                            <a href="#" class="social-icon-wrapper google" style="color: #4285f4 !important; font-size: 1.6rem !important; text-decoration: none !important;"><i class="fab fa-google"></i></a>
                            <a href="#" class="social-icon-wrapper facebook" style="color: #3b5998 !important; font-size: 1.6rem !important; text-decoration: none !important;"><i class="fab fa-facebook-f"></i></a>
                            <a href="#" class="social-icon-wrapper tiktok" style="color: #000000 !important; font-size: 1.6rem !important; text-decoration: none !important;"><i class="fab fa-tiktok"></i></a>
                        </div>
                    </div>
