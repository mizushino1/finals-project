        ...
        <div class="row w-100 justify-content-center">
            <div class="col-12 col-md-11 col-lg-10 col-xl-9">
                ...
                <div class="auth-card row g-0">
                    ...
                    <div class="col-12 col-md-5 info-side p-5 d-flex flex-column justify-content-center align-items-start">
                        ...
                        <button class="btn btn-create-account px-4 py-2">Create Account</button>
                    </div>

                    <div class="col-12 col-md-7 form-side p-5 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="text-center mb-4 d-flex flex-column align-items-center">
                                ...
                                <div class="social-medias d-flex gap-4 justify-content-center align-items-center">
                                    ...
                                    <a href="#" class="social-icon-wrapper tiktok">
                                        <img src="https://img.magnific.com/premium-vector/tik-tok-logo_578229-290.jpg?semt=ais_hybrid&w=740&q=80" alt="TikTok" class="social-logo social-logo--rounded">
                                    </a>
                                </div>
                            </div>
                        </form>
