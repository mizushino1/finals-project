...
$id   = $_SESSION['account_id']; // Core root account_id from session

try {
    // 2. Query matching your structural relational DDL layout
    if ($role === 'user' || $role === 'client') {
        ...
        echo json_encode(['success' => false, 'message' => 'Invalid account role configuration.']);
        exit;
    }
