...
$routes = [
    ...
    '/messages/conversation' => 'views/messages/conversation.php',
    '/payments/checkout'     => 'views/payments/checkout.php',
    '/payments/history'     => 'views/payments/history.php',
    '/admin'                 => 'views/admin/dashboard.php',
    '/admin/commissions'     => 'views/admin/commissions.php',
    '/admin/payments'        => 'views/admin/payments.php',
    ...
    '/payments/success' => 'views/payments/success.php',
    '/payments/transactions' => 'views/payments/transactions.php',
];
